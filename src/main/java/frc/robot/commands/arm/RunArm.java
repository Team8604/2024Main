...
public class RunArm extends Command {
    ...
    public void execute() {
        ...
        /*if(!RobotContainer.arm.rightFowardLimitSwitch.isPressed() && RobotContainer.arm.leftFowardLimitSwitch.isPressed()){
            RobotContainer.arm.setRightArmSpeed(adjustArm);
        } else{ */
