...
public final class Constants {
  ...
  public static class DriveConstants {
    ...
    public static final double kMaxRotate = 1;
    public static final double kNormalRotate = 0.525;
  ...
  public static class ArmConstants {
    ...
    public static final double kAutoShootPos = 0.409; //distance is about 1.5-2 robots
  ...
  public static class AutoConstants {
    ...
    public static final double kDrivePower = 0.2;
  }
}